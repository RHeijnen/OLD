...
public class Controller extends App {
    ...
    public void setMainWindow(String Title, String fxmlURL) {
        try {
          ...
          //FXController.App.theStage.setScene(new Scene(FXController.App.root, FXController.App.GetScreenWorkingWidth() / 1.1, FXController.App.GetScreenWorkingHeight() / 1.1));
            App.theStage.setScene(new Scene(App.root,400, 600));
          //FXController.App.theStage.centerOnScreen();
            App.theStage.show();
